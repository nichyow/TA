...
\usepackage{floatrow} % for customizing float (figure and table) positions; also handles [H] placement
\usepackage{listings} % for code listing
% Definisi bahasa JavaScript manual (workaround: versi listings.sty terbaru di MiKTeX
% tidak lagi menyertakan definisi bawaan untuk "JavaScript").
\lstdefinelanguage{JavaScript}{
    keywords={break, case, catch, class, const, continue, debugger, default, delete, do, else, export, extends, finally, for, function, if, import, in, instanceof, interface, let, new, return, super, switch, this, throw, try, typeof, var, void, while, with, yield, async, await, of, static, get, set},
...
\usepackage{multirow} % for merging table cells across rows
\usepackage{tikz} % for drawing diagrams
\usetikzlibrary{arrows.meta, positioning} % tikz libraries for arrows and node positioning
...
% --- Jangan paksa halaman rata ke margin bawah (hindari jarak antar-paragraf melar) ---
\raggedbottom
...
%\input{10 Daftar Persamaan.tex} % dihapus atas permintaan
%\input{11 Daftar Algoritma.tex} % dihapus atas permintaan
\input{12 Daftar Listing.tex}
%\input{13 Daftar Simbol.tex} % dihapus atas permintaan
%\input{14 Daftar Singkatan.tex} % dihapus atas permintaan
...
%\input{Lampiran-B.tex} % dihapus atas permintaan
\end{appendices}
\backmatter
